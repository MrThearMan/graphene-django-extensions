...
- All code should be typed when possible.
  ...
  - Create all custom types in `graphene_django_extensions/typing.py` and import them from there.
    This avoids circular imports.
  - Use of `TypedDict` is encouraged where dicts would be used.
  - Also import common types like `List` from `graphene_django_extensions/typing.py` instead of the built-in `typing` module.
...
[docs]: https://mrthearman.github.io/graphene-django-extensions/
[Issue]: https://github.com/MrThearMan/graphene-django-extensions/issues/new/choose
[bug report]: https://github.com/MrThearMan/graphene-django-extensions/issues/new?template=bug_report.yml
[feature request]: https://github.com/MrThearMan/graphene-django-extensions/issues/new?template=feature_request.yml
[discussions section]: https://github.com/MrThearMan/graphene-django-extensions/discussions
[pull request]: https://github.com/MrThearMan/graphene-django-extensions/compare
[fork]: https://github.com/MrThearMan/graphene-django-extensions/fork
[setup]: https://github.com/MrThearMan/graphene-django-extensions/blob/main/CONTRIBUTING.md#setting-up-the-environment
[tox]: https://tox.wiki/
[code-guidelines]: https://github.com/MrThearMan/graphene-django-extensions/blob/main/CONTRIBUTING.md#guidelines-for-writing-code
[docs-guidelines]: https://github.com/MrThearMan/graphene-django-extensions/blob/main/CONTRIBUTING.md#guidelines-for-writing-documentation
[reviewed]: https://github.com/MrThearMan/graphene-django-extensions/blob/main/CONTRIBUTING.md#code-review-process
[Github Actions]: https://github.com/features/actions
[pre-commit ci]: https://pre-commit.ci/
[new release]: https://github.com/MrThearMan/graphene-django-extensions/blob/main/CONTRIBUTING.md#creating-a-new-release
[semantic versioning]: https://semver.org/
[Draft a new release]: https://github.com/MrThearMan/graphene-django-extensions/releases/new
